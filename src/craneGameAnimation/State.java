...
import electricPotAnimation.ElectricPot;
...
public class State extends JLabel {
	...
	// 座標
	int s_x = FrontIllustration.FRONT_ILL_X + 200;// 基準
	...
	private void createTriggerLabel() {
		...
		// ラベル名を設定
		trigger_label.setText(tri_this_side_switch);
		// 文字のフォントの設定
	...
	private void createCharTrigger() {
		...
		// ラベルの位置と大きさの設定
		trigger.setBounds(s_x+300, s_y-25, 140, 35);
		// 文字位置の設定
