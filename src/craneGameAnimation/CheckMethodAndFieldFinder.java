...
public class CheckMethodAndFieldFinder {
	...
	// トリガーフォルダー
	public static boolean is_tri_coin = false;
	public static boolean is_tri_right_button = false;
	public static boolean is_tri_right_switch = false;
	public static boolean is_tri_right_release = false;
	public static boolean is_tri_back_button = false;
	public static boolean is_tri_back_switch = false;
	public static boolean is_tri_back_release = false;
	public static boolean is_tri_thirty = false;
	public static boolean is_tri_left_switch = false;
	public static boolean is_tri_this_side_switch = false;
	public static boolean is_tri_crane_up = false;
	public static boolean is_tri_this_and_left_switch = false;
